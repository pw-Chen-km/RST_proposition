...
async def main(args: argparse.Namespace):
    ...
    # Check if the API key is set
        ...
        if "openai" in args.embedding_model.lower() or "text-embedding" in args.embedding_model.lower() or os.getenv("LLM_API_KEY"):
            from langchain_openai import OpenAIEmbeddings
            embedding = OpenAIEmbeddings(model=args.embedding_model, api_key=SecretStr(api_key))
        else:
